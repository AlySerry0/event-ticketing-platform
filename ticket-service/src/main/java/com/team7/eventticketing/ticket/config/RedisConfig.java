...
public class RedisConfig implements CachingConfigurer {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        caches.put("S4-F1", baseConfig(Duration.ofMinutes(5), serializer));
        caches.put("S4-F3",  baseConfig(Duration.ofMinutes(10), serializer));
        caches.put("S4-F5", baseConfig(Duration.ofMinutes(5),  serializer));
        caches.put("S4-F6", baseConfig(Duration.ofMinutes(10), serializer));
        caches.put("S4-F8", baseConfig(Duration.ofMinutes(15), serializer));
        ...
        caches.put("ticket", baseConfig(Duration.ofMinutes(15), serializer));
